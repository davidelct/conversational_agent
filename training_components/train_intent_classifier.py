...
slot_filling = pd.read_csv("../data/augmented/slot_filling.csv")
df = pd.concat([tix, interests, info, fallback, welcome, slot_filling])
...
pickle.dump(vectorizer, open("../models/tfidf1.pkl", "wb"))
y = df['class'].tolist()
